...
Star _$StarFromJson(Map<String, dynamic> json) {
  return Star(
    ...
    accuracyCount: (json['accuracyCount'] as num)?.toDouble(),
    rate: (json['rate'] as num)?.toDouble(),
    liveStatus: (json['liveStatus'] as num)?.toDouble(),
    workStatus: (json['workStatus'] as num)?.toDouble(),
